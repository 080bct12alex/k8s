// for separate pod multiple containers
...
const mongoHost = process.env.MONGO_HOST || 'localhost'; // Use environment variable or default to localhost
const mongoPort = process.env.MONGO_PORT || '27017';

// Connect to MongoDB   // use ' ' for connection string not ` ` without env variable 
